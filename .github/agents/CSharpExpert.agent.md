...
- **Use the framework already in the solution** (TUnit/xUnit/NUnit/MSTest) for new tests.

### TUnit

- Packages: `TUnit`
- No class attribute; use `[Test]` for test methods.
- Parameterized tests: `[Test]` with `[Arguments]`
