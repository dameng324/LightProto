...
[InheritsTests]
public partial class CollectionTests : BaseTests<CollectionTests.Message, ArrayTestsMessage>
{
    [ProtoContract]
    ...
    public partial record Message
    {
        ...
        public Collection<int> Property { get; set; } = [];
    ...
    {
        byte[] bytes = [];
        var deserialized = Serializer.Deserialize<Collection<int>>(bytes);
