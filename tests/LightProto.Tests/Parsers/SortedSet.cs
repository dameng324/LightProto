...
[InheritsTests]
public partial class SortedSetPackedTests : BaseTests<SortedSetPackedTests.Message, ISetPackedTestsMessage>
{
    [ProtoContract]
    ...
    {
        return GetMessages().Select(o => new ISetPackedTestsMessage() { Property = { o.Property } });
    }
