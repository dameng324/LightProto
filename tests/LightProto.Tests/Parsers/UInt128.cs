...
[InheritsTests]
public partial class UInt128Tests : BaseTests<UInt128Tests.Message, Int128TestsMessage>
{
    [ProtoContract]
    ...
    public partial record Message
    {
        ...
        public UInt128 Property { get; set; }
    }
    ...
    {
        yield return new() { Property = UInt128.MinValue };
        yield return new() { Property = UInt128.MaxValue };
        yield return new() { Property = UInt128.Zero };
    ...
    public override async Task AssertGoogleResult(Int128TestsMessage clone, Message message)
    {
        ...
        await Assert.That(new UInt128(clone.Property.Upper, clone.Property.Lower)).IsEqualTo(message.Property);
    }
}
#endif
