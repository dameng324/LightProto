...
[InheritsTests]
public partial class ReadonlyConcurrentDictionaryPropertyTests : BaseTests<ReadonlyConcurrentDictionaryPropertyTests.Message, MapTestsMessage>
{
    [ProtoContract]
    ...
    public partial record Message
    {
        ...
        public ConcurrentDictionary<int,string> Property { get; } = [];
