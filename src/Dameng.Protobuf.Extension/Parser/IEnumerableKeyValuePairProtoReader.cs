    ...
    where TDictionary : IEnumerable<KeyValuePair<TKey, TValue>>
{
    ...
    public TDictionary ParseFrom(ref ParseContext input)
    {
    ...
    private T Read<T>(ref ParseContext ctx, IProtoReader<T> reader)
    {
    ...
    public KeyValuePair<TKey, TValue> ReadMapEntry(ref ParseContext ctx)
    {
