...
namespace LightProto
{
    ...
    {
        public static IProtoWriter<ICollection<T>> GetCollectionWriter<T>(
        ...
        public static IProtoReader<List<TItem>> GetListReader<TItem>(
        ...
        > GetObservableCollectionReader<TItem>(this IProtoReader<TItem> reader)
        {
