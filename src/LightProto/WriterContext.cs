...
namespace LightProto
{
    ...
    public ref struct WriterContext
    {
        ...
        /// </summary>
        /// <param name="value">The value to write</param>
        public void WriteFixedBigEndian32(uint value) => WritingPrimitives.WriteRawBigEndian32(ref buffer, ref state, value);
        ...
        /// </summary>
        /// <param name="value">The value to write</param>
        public void WriteByte(byte value) => WritingPrimitives.WriteUInt32(ref buffer, ref state, value);

        /// <summary>
        /// Writes a byte field value as sint32, without a tag.
        /// </summary>
        /// <param name="value">The value to write</param>
        public void WriteSByte(sbyte value) => WritingPrimitives.WriteInt32(ref buffer, ref state, value);

        /// <summary>
        /// Writes a byte field value as sint32, without a tag.
        /// </summary>
        /// <param name="value">The value to write</param>
        public void WriteSSByte(sbyte value) => WritingPrimitives.WriteSInt32(ref buffer, ref state, value);

        /// <summary>
        /// Writes a byte field value as fixed32, without a tag.
        /// </summary>
        /// <param name="value">The value to write</param>
        public void WriteFixedByte(byte value) => WritingPrimitives.WriteFixed32(ref buffer, ref state, value);

        /// <summary>
        /// Writes a byte field value as fixed32, without a tag.
        /// </summary>
        /// <param name="value">The value to write</param>
        public void WriteSFixedByte(sbyte value) => WritingPrimitives.WriteSFixed32(ref buffer, ref state, value);
