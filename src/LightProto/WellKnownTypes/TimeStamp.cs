...
namespace LightProto.WellKnownTypes;
...
public sealed partial class Timestamp:IEquatable<Timestamp>,IComparable<Timestamp>
{
    ...
    public static Timestamp FromDateTime(DateTime dateTime)
    {
        ...
        int nanoseconds =
            (int)(dateTime.Ticks % TimeSpan.TicksPerSecond) * Duration.NanosecondsPerTick;
    ...
    public static string ToJson(long seconds, int nanoseconds, bool diagnosticOnly)
    {
