...
{
    public sealed class BlockingCollectionProtoWriter<T> : IEnumerableProtoWriter<BlockingCollection<T>, T>
    {
        public BlockingCollectionProtoWriter(IProtoWriter<T> itemWriter, uint tag, int itemFixedSize)
            : base(itemWriter, tag, static collection => collection.Count, itemFixedSize) { }
    }

    public sealed class BlockingCollectionProtoReader<T> : IEnumerableProtoReader<BlockingCollection<T>, T>
    {
