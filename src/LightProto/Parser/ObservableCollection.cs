...
{
    public sealed class ObservableCollectionProtoWriter<T> : IEnumerableProtoWriter<ObservableCollection<T>, T>
    {
        public ObservableCollectionProtoWriter(IProtoWriter<T> itemWriter, uint tag, int itemFixedSize)
            : base(itemWriter, tag, static collection => collection.Count, itemFixedSize) { }
    }

    public sealed class ObservableCollectionProtoReader<T> : IEnumerableProtoReader<ObservableCollection<T>, T>
    {
