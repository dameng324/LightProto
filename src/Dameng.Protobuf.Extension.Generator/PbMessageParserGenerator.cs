...
public class PbMessageParserGenerator : ISourceGenerator
{
    ...
    public void Execute(GeneratorExecutionContext context)
    {
        ...
        foreach (var syntaxTree in context.Compilation.SyntaxTrees)
        {
            ...
            {
                var targetType = semanticModel.GetDeclaredSymbol(typeDeclaration) as INamedTypeSymbol;
        ...
        context.AddSource("Dameng.Protobuf.Extension.g.cs", SourceText.From(sourceBuilder.ToString(), Encoding.UTF8));
    }
}